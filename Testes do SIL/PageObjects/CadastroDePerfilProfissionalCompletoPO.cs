...
{
    public class CadastroPerfilProfissionalCompletoPO
    {
        ...
        private By byAbaCadastroPerfilProfissionalCompleto;
        ...
        public CadastroPerfilProfissionalCompletoPO(IWebDriver driver)
        {
            this.driver = driver;
            ...
            byAbaCadastroPerfilProfissionalCompleto = By.LinkText("Cadastro perfil profissional – completo");
        ...
        public void AbrirJanelaCadastrodePerfilProfissionalCompleto()
        {
