...
{
    public class CadastroDeVeiculoCompletoPO
    {
        ...
        private By byAbaCadastroDeVeiculoCompleto;

        //Aba Dados do Veiculo         
        private By byPlaca;
        private By byNumeroChassi;
        private By byRenavam;
        private By byNumeroDocertificado;
        private By byMarca;
        ...
        private By byDtVencimentoLicenciamento;
        ...
        public CadastroDeVeiculoCompletoPO(IWebDriver driver)
        {
            this.driver = driver;
            ...
            byAbaCadastroDeVeiculoCompleto = By.LinkText("Cadastro de veículo – completo");

            //Aba Dados Do Veiculo
            byPlaca = By.Id("txtPlaca");
            byNumeroChassi = By.Id("txtChassi");
            byRenavam = By.Id("txtRenavam");
            byNumeroDocertificado = By.Id("txtCertificado");
            ...
            byDtVencimentoLicenciamento = By.Id("edtVencLicencia");
            ...
            byDDDCel = By.Id("txtDDDTelCel");
            byCel = By.Id("txtCelular");
        ...
        public void AbrirJanelaCadastrodeVeículoCompleto()
        {
            driver.FindElement(byAbaCadastro).Click();
            driver.FindElement(byAbaVeiculo).Click();
            driver.FindElement(byAbaCadastroDeVeiculoCompleto).Click();
        }
